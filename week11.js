...
function makeEight() {
	...
	const practicum8List = document.createElement('li');
	practicum8List.textContent = 'New Element';
	practicum8.append(practicum8List);
}
...
function makeNine() {
	...
	const practicum9Option = document.createElement('option');
	practicum9Option.textContent = 'New Option';
	practicum9.append(practicum9Option);
}
...
function makeTen() {
	...
	practicum10.style = 'dispaly:none';
}
...
function makeEleven() {
	...
	practicum11.style = 'width:400px; height:200px; background-color: yellow';
}
...
function makeTwelve() {
	...
	practicum12.classList.toggle('resizeable__practicum12');
}
//Задание 13
...
function makeNineteen() {
	...
	practicum19.classList.toggle('active');
}
...
function makeTwenty() {
	...
	p20.textContent = "Добавлено в начало";
	practicum20.prepend(p20);
...
function makeTwentyOne() {
	...
	p21.textContent = "Добавлено в конец";
	practicum21.append(p21);
}
...
function makeTwentyTwo() {
	...
	const srcPracticum22 = practicum22.hasAttribute('src');
	const result22 = document.getElementById('result22');
	result22.textContent = 'Атрибут "src" присутствует: ' + srcPracticum22;
}
...
function makeTwentyFour() {
	...
	practicum24.value = "Новое значение";
}
...
function makeTwentyFive() {
	...
	const attribute25 = practicum25.getAttribute('data-info');
	const infoOutput = document.getElementById('infoOutput');
	infoOutput.textContent = 'Добавленный атрибут: ' + attribute25;
}
...
function makeTwentySeven() {
	...
	const highlightPracticum27 = practicum27.classList.contains('highlight');
	const resulPracticum27 = document.getElementById('result');
	resulPracticum27.textContent = 'содержит класс "highlight": ' + highlightPracticum27;
}
...
button28.addEventListener('click', handleClick);
...
input29.addEventListener('click', handleChange);
